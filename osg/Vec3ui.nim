...
proc constructVec3ui*(): Vec3ui {.constructor,importcpp: "Vec3ui".}

proc constructVec3ui*(r: Value_type, g: Value_type, b: Value_type): Vec3ui {.constructor,importcpp: "Vec3ui(@)".}
