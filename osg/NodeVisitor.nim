...
import ClipNode  # provides: osg::ClipNode
import Group  # provides: osg::Group
import CopyOp  # provides: osg::CopyOp
import ValueStack  # provides: osg::ValueStack
import PagedLOD  # provides: osg::PagedLOD
import ProxyNode  # provides: osg::ProxyNode
import OccluderNode  # provides: osg::OccluderNode
import Billboard  # provides: osg::Billboard
import FrameStamp  # provides: osg::FrameStamp
import OcclusionQueryNode  # provides: osg::OcclusionQueryNode
type
  TraversalMode* {.size:sizeof(cuint),header: "NodeVisitor", importcpp: "osg::NodeVisitor::TraversalMode".} = enum
    trvrslmdTRAVERSE_NONE = 0,
    trvrslmdTRAVERSE_PARENTS = 1,
    trvrslmdTRAVERSE_ALL_CHILDREN = 2,
    trvrslmdTRAVERSE_ACTIVE_CHILDREN = 3

  VisitorType* {.size:sizeof(cuint),header: "NodeVisitor", importcpp: "osg::NodeVisitor::VisitorType".} = enum
    vstrtypNODE_VISITOR = 0,
    vstrtypUPDATE_VISITOR = 1,
    vstrtypEVENT_VISITOR = 2,
    vstrtypCOLLECT_OCCLUDER_VISITOR = 3,
    vstrtypCULL_VISITOR = 4,
    vstrtypINTERSECTION_VISITOR = 5
